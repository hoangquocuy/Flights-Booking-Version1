    ...
    <body style="background-color: #dadde6;overflow-x:hidden;">
        ...
        <div id="list-booking" class="content-container active-onclick" style="padding-left: 260px;padding-right: 30px">
            <div class="container-fluid" >
                ...
                <div id="message-cancel-load" style="margin-top: 30px; margin-left: 300px" class="active-onclick" role="alert">
                    <img style="width: 200px" src="https://speed.family/wp-content/uploads/2020/04/loading.gif">
                </div>
