...
<html>
    ...
    <body style="background-image: url('https://www.vietjetair.com/static/media/cloud-bg-5.9b668827.png')">
                        ...
                        <div class="container" style="background-color: white;height: 64px;" >
                            ...
                            <c:forEach var="c" items="${dateDepart}" varStatus="loop">
                                <c:if test="${loop.index == 1}">
                                    <div style="background-color: yellow;padding-left: 130px;height: 64px;padding-top: 20px"  class="col-4"><h5 onclick="test(this.textContent)">${c}</h5></div>
                                    </c:if>
                                    <c:if test="${loop.index != 1}">
                                    <div class="col-4" style="padding-top: 20px;padding-left: 130px"><h5 onclick="test(this.textContent)">${c}</h5></div>
                                    </c:if>
                                </c:forEach>
        ...
        <script>
                                            ...
                                            function test(departNextDate) {

                                                $.ajax({
                                                    url: '/Spring_MVC_Project_Final/search-flight-next',
                                                    type: 'get',
                                                    data: {
                                                        departNextDate: departNextDate
                                                    },
                                                    success: function (value) {
                                                        console.log(value);
                                                        $('#next-page').html(value);
                                                    }
                                                });
                                            }
                                            ;
