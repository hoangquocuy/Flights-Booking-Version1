...
<html>
    ...
    <body style="background:#dadde6;">
        ...
        <div id="payment-loading" class="padding display-chnage-payment" style="position: absolute ;margin-top: 100px;z-index: 2; margin-top: 200px ; margin-left: 450px" >
            <div class="row">
                <img style="width: 100px" src="https://speed.family/wp-content/uploads/2020/04/loading.gif">
            </div>
        </div>
